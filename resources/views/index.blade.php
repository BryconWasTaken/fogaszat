...
<body>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        <li><a class="menu" href="{{ route('patients.index') }}">Patients </a></li>
					        <li><a class="menu" href="{{ route('visit.index') }}">Visits</a></li>
                            <li><a class="menu" href="{{ route('treatment.index') }}">Treatments</a></li>
					      </ul>
					    </div><!-- /navbar-collapse -->
					  </div><!-- / .container-fluid -->
					</nav>
			        ...
			        <div class="carousel-inner" role="listbox">
			            <div class="item active">
			                ...
			                <div class="carousel-caption">
		               			<h1>providing</h1>
		               			<p>highquality dentistry service for men &amp; women</p>
	...
	<section class="service text-center" id="service">
		<div class="container">
			<div class="row">
				<h2>our services</h2>
				<h4>Our dentistry has been the industry's standard ever since the 1500s</h4>
